...
The Tailwind v3 / Radix-based docs and registry are frozen at [v3-ui-x.junwen-k.dev](https://v3-ui-x.junwen-k.dev) — no further updates, but still fully installable straight from the live registry:

```bash
npx shadcn@latest add https://v3-ui-x.junwen-k.dev/r/styles/default/<component>.json
```
